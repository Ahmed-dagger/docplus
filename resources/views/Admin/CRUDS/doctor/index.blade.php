        ...
        <div class="card-body">
            <table id="table" class="table table-bordered nowrap table-striped align-middle"
                ...
                <tr>
                    ...
                    <th>{{helperTrans('admin.Contract')}}</th>
...
@section('js')
    <script>
        var columns = [
            ...
            {data: 'specialization_id', name: 'specialization_id'},
            {data: 'lang', name: 'lang'},
            {data: 'weight', name: 'weight'},
            {data: 'status', name: 'status'},
            {data: 'doctor_times', name: 'doctor_times'},
            {data: 'doctor_contract', name: 'doctor_contract'},
