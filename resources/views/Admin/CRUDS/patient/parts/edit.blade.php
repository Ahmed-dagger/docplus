...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('patients.update',$row->id)}}">
    ...
    <div class="row g-4">
        ...
        <!-- Check if the authenticated user's email is 'super_admin@app.com' -->
        ...
        @else
            ...
            <div class="col-sm-12 pb-3 p-2">
                ...
                <textarea name="address" id="address" class="form-control " rows="5" placeholder="">{{$row->address}}</textarea>
            </div>
