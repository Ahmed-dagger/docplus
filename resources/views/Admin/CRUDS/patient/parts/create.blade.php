...
<form id="form" enctype="multipart/form-data" method="POST" action="{{ route('patients.store') }}">
    ...
    <div class="row g-4">
        ...
        @if(auth()->guard('admin')->user()->email != 'super_admin@app.com')
        ...
        @else
            <!-- Admin with email 'super_admin@app.com' will see all fields -->
            ...
            <div class="d-flex flex-column mb-7 fv-row col-sm-6">
                ...
                <!--end::Label-->
                <input id="postcode" required type="text" class="form-control form-control-solid" placeholder="{{ helperTrans('admin.postcode') }}" name="postcode" value=""/>
            </div>
            ...
            <div class="col-sm-12 pb-3 p-2">
                ...
                <textarea name="address" id="address" class="form-control" rows="5" placeholder=""></textarea>
            </div>
        @endif
