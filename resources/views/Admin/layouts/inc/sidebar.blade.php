...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{route('admin.index')}}" class="logo logo-dark">
            <span class="logo-sm"><img src="{{get_file(setting()->logo_header)}}" alt="" height="22"></span>
            <span class="logo-lg"><img src="{{get_file(setting()->logo_header)}}" alt="" height="40"></span>
        </a>
        <!-- Light Logo-->
               ...
               {{-- <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="providers">
                        <ul class="nav nav-sm flex-column">
                            ...
                            @if(auth()->guard('admin')->user()->hasPermission('hospitals_read'))
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="{{route('hospitals.index')}}"><span data-key="t-dashboards">  {{helperTrans('admin.Hospitals')}} </span>
                                    </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="{{route('pharmacies.index')}}">
                                    <span data-key="t-dashboards">  {{helperTrans('admin.Pharmacies')}} </span>
                                </a>
                            </li> <!-- end Dashboard Menu -->
                            @endif
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="{{route('radiology.index')}}">
                                    <span data-key="t-dashboards">  {{helperTrans('admin.Radiology')}} </span>
                                </a>
                            </li> <!-- end Dashboard Menu -->
                            @endif
                ...
                @if(auth()->guard('admin')->user()->hasPermission('insurance_people_read'))
                    <li class="nav-item">
                        ...
                        <i class="fa-solid fa-users"></i><span data-key="t-dashboards">  {{helperTrans('admin.Insurance People')}}</span>
                        </a>
                    </li>
                @endif
                ...
                @if(auth()->guard('admin')->user()->hasPermission('insurance_companies_read'))
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{route('insurance_companies.index')}}">
                            <i class="fa-solid fa-pills"></i> <span data-key="t-dashboards">  {{helperTrans('admin.Insurance Company')}}</span>
                        </a>
                    </li>
                @endif
...
<!--                </li>-->
                ...
                @if(auth()->guard('admin')->user()->hasPermission('sign_read'))
                <li class="nav-item">
                ...
                @if(auth()->guard('admin')->user()->hasPermission('medical_operations_read'))
