...
Route::group(['prefix' => 'patient/auth'], function () {
    ...
    Route::middleware('ApiLogin')->group(function () {
        ...
        Route::post('make_booking', [\App\Http\Controllers\Api\Patient\BookingController::class, 'make_booking']);
            Route::get('success', [\App\Http\Controllers\Api\Patient\BookingController::class, 'success'])->name('paypal.success');
        Route::post('cancel', [\App\Http\Controllers\Api\Patient\BookingController::class, 'cancel'])->name('paypal.cancel');
        Route::post('initiate-payment', [\App\Http\Controllers\Api\Patient\BookingController::class, 'initiatePayment']);
...
Route::group(['prefix' => 'doctor/auth'], function () {
    ...
    Route::middleware('ApiDoctorLogin')->group(function () {
        ...
        ### Specialization Booking
        Route::get('specialization_bookings', [\App\Http\Controllers\Api\Doctor\SpecializationBookingController::class, 'bookings']);
        Route::post('specialization_accept_booking', [\App\Http\Controllers\Api\Doctor\SpecializationBookingController::class, 'accept_booking']);
