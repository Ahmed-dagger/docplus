...
Route::group(
    ...
    Route::group([ 'middleware' => 'admin', 'localeSessionRedirect', 'localizationRedirect', 'localeViewPath' ], function () {
        ...
        Route::get('doctor_contract_renewal/{contract_id}/{doctor_id}', [\App\Http\Controllers\Admin\DoctorController::class, 'renewContract'])->name('admin.doctor_contract_renewal');
        Route::post('doctor_contract_renewal/store', [\App\Http\Controllers\Admin\DoctorController::class, 'storeRenewal'])->name('admin.doctor_contract_renewal_store');
        // <-- End Doctor Contract -->
        ...
        ### Hospitals Bracnhes
        Route::resource('hospital_branches', \App\Http\Controllers\Admin\HospitalBranchController::class);
